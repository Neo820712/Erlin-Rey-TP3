...
- - **Custom properties para todos los colores:** paleta Intel + colores de señal en `:root`. No
  hardcodear hex en las reglas. La paleta Intel (azules basados en la identidad de intel.com:
  `--color-primary` Intel Blue `#0068b5`, `--color-primary-dark` Classic Blue `#00285a`,
  `--color-accent` Energy Blue `#00c7fd`) está definida en el `:root` de `frontend/index.html`
  (fuente de verdad) y documentada en `propuesta/planificacion-del-proyecto.md`.
